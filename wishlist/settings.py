...
DATABASES = {
    'default': {
        ...
        'HOST': '/cloudsql/wishlist-406200:us-central1:wishlist-db-mysql',
        'PORT': '3306'
    }
}
...
if not os.getenv('GAE_INSTANCE'):
    ...
    GS_STATIC_FILE_BUCKET = 'wishlist-406200.appspot.com'
    ...
    GS_CREDENTIALS = service_account.Credentials.from_service_account_file(
        'travel_credentials.json'
    )

    MEDIA_URL = f'https://stoage.cloud.google.com{GS_BUCKET_NAME}/media/'
